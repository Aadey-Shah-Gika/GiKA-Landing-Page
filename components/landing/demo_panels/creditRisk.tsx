...
const CreditRiskDemo = () => {
  ...
  const startAnimation = () => {
    ...
    setStage(1);
    setInputValue(
      "How do our top competitors' pricing for luxury beach resorts compare to ours during peak season?"
    );
            ...
            <div className="space-y-4 min-h-full flex flex-col justify-end">
              ...
              <div className="flex justify-center mb-6">
                <div className="text-sm text-center text-gray-600 max-w-[85%]">
                  Welcome to GiKA Travel Insights. Ask me about competitors,
                  pricing strategy, or market trends for your luxury beach
                  resorts.
                </div>
              </div>
                ...
                <div className="flex justify-center mb-6 px-4">
                  <div className="text-xs sm:text-sm text-gray-700 max-w-[90%]">
                    {typingComplete ? (
                      <div>
                        <p>
                          Based on our competitive analysis, during the upcoming
                          peak season (Dec–Feb), our average nightly rate for
                          luxury beach resorts is{" "}
                          ...
                          than the median of our top 5 competitors.
                        </p>

                        <p className="mt-4">
                          Notably, Competitor A has increased prices by{" "}
                          <span className="font-semibold text-indigo-700">
                            18% YoY
                          </span>
                          , while maintaining 87% occupancy. In contrast, our
                          occupancy projection is{" "}
                          <span className="font-semibold text-purple-700">
                            72%
                          </span>
                          , indicating potential price sensitivity.
                        </p>

                        <p className="mt-4">
                          Competitors have bundled amenities (e.g., spa credits,
                          airport transfers) in 60% of listings, whereas only
                          25% of our offerings include such bundles —
                          contributing to their higher conversion rates.
                        </p>
                  ...
                  {showSection.recommendations && (
                    ...
                    >
                      ...
                      <div className="space-y-3">
                        <div className="bg-white/60 rounded-lg p-3 backdrop-blur-sm">
                          <h4 className="text-xs font-semibold text-indigo-800 mb-1">
                            A/B Test Bundled Offerings
                          </h4>
                          <p className="text-xs text-gray-700">
                            Test premium packages with spa credits and airport
                            transfers to match competitor conversion rates.
                          </p>
                        ...
                        <div className="bg-white/60 rounded-lg p-3 backdrop-blur-sm">
                          ...
                          <p className="text-xs text-gray-700">
                            Implement destination-specific pricing clusters to
                            optimize for both occupancy and revenue.
                          </p>
                          <div className="mt-1.5 flex items-center">
                            <div className="h-1 w-8 bg-gradient-to-r from-purple-400 to-indigo-400 rounded-l-full"></div>
                            <div className="h-1 w-8 bg-gradient-to-r from-indigo-400 to-blue-400"></div>
                        ...
                        <div className="bg-white/60 rounded-lg p-3 backdrop-blur-sm">
                          ...
                          <p className="text-xs text-gray-700">
                            Emphasize unique experiences and exclusivity to
                      ...
                      <div className="mt-3 flex justify-end">
                        <button
                          className="flex items-center bg-purple-600 text-white text-xs px-3 py-1.5 rounded-lg hover:bg-purple-700 transition-colors"
                          onClick={() =>
                            window.open(
                              "/GiKA_Luxury_Resort_Analysis_Q2_2025.html",
                              "_blank"
                            )
                          }
                        >
...
const CreditRiskDemoWithStyles = () => (
  <>
...
export default CreditRiskDemoWithStyles;
